...
Last refreshed: 2026-02-21T16:15:20.578Z

Total tracked papers: **241**

<!-- contributor-chart:start -->

## Contributor Ranking

Bars show contributors with at least 2 papers (name variants merged, full-name labels), sorted left to right by paper count. Total shown: **108**.

```{=html}
<style>
.contrib-bars-wrap { overflow-x: auto; border: 1px solid #d7dde3; border-radius: 8px; padding: 10px; background: #fff; }
.contrib-bars { display: flex; align-items: flex-end; gap: 4px; min-width: max-content; height: 470px; }
.contrib-item { width: 14px; flex: 0 0 14px; display: flex; flex-direction: column; align-items: center; justify-content: flex-end; }
.contrib-count { width: 0; height: 10px; position: relative; overflow: visible; margin-bottom: 2px; }
.contrib-count span { position: absolute; left: 50%; transform: translateX(-50%); white-space: nowrap; font-size: 8px; color: #4b5563; line-height: 1; pointer-events: none; }
.contrib-bar { width: 12px; background: #1f77b4; border-radius: 3px 3px 0 0; min-height: 4px; }
.contrib-item.top .contrib-bar { background: #0f5f9a; }
.contrib-label { margin-top: 2px; width: 0; height: 180px; position: relative; overflow: visible; }
.contrib-label span { position: absolute; left: 0; top: 0; transform-origin: left top; transform: rotate(30deg); white-space: nowrap; font-size: 10px; color: #111827; line-height: 1; pointer-events: none; }
.contrib-note { color: #4b5563; font-size: 0.92rem; margin-top: 0.45rem; }
</style>
<div class="contrib-bars-wrap">
  <div class="contrib-bars">
    <div class="contrib-item top" title="Mark van der Laan (the godfather himself): 82 papers"><div class="contrib-count"><span>82</span></div><div class="contrib-bar" style="height:260.00px"></div><div class="contrib-label"><span>Mark van der Laan (the godfather himself)</span></div></div>
    <div class="contrib-item" title="Maya L. Petersen: 19 papers"><div class="contrib-count"><span>19</span></div><div class="contrib-bar" style="height:60.24px"></div><div class="contrib-label"><span>Maya L. Petersen</span></div></div>
    <div class="contrib-item" title="Laura B. Balzer: 13 papers"><div class="contrib-count"><span>13</span></div><div class="contrib-bar" style="height:41.22px"></div><div class="contrib-label"><span>Laura B. Balzer</span></div></div>
    <div class="contrib-item" title="Alan Hubbard: 12 papers"><div class="contrib-count"><span>12</span></div><div class="contrib-bar" style="height:38.05px"></div><div class="contrib-label"><span>Alan Hubbard</span></div></div>
    <div class="contrib-item" title="Iván Díaz: 10 papers"><div class="contrib-count"><span>10</span></div><div class="contrib-bar" style="height:31.71px"></div><div class="contrib-label"><span>Iván Díaz</span></div></div>
    <div class="contrib-item" title="Rachael V. Phillips: 10 papers"><div class="contrib-count"><span>10</span></div><div class="contrib-bar" style="height:31.71px"></div><div class="contrib-label"><span>Rachael V. Phillips</span></div></div>
    <div class="contrib-item" title="Antoine Chambaz: 9 papers"><div class="contrib-count"><span>9</span></div><div class="contrib-bar" style="height:28.54px"></div><div class="contrib-label"><span>Antoine Chambaz</span></div></div>
    <div class="contrib-item" title="David Benkeser: 9 papers"><div class="contrib-count"><span>9</span></div><div class="contrib-bar" style="height:28.54px"></div><div class="contrib-label"><span>David Benkeser</span></div></div>
    <div class="contrib-item" title="Helene C. W. Rytgaard: 8 papers"><div class="contrib-count"><span>8</span></div><div class="contrib-bar" style="height:25.37px"></div><div class="contrib-label"><span>Helene C. W. Rytgaard</span></div></div>
    <div class="contrib-item" title="Ivana Malenica: 8 papers"><div class="contrib-count"><span>8</span></div><div class="contrib-bar" style="height:25.37px"></div><div class="contrib-label"><span>Ivana Malenica</span></div></div>
    <div class="contrib-item" title="Alejandro Schuler: 7 papers"><div class="contrib-count"><span>7</span></div><div class="contrib-bar" style="height:22.20px"></div><div class="contrib-label"><span>Alejandro Schuler</span></div></div>
    <div class="contrib-item" title="Cheng Ju: 7 papers"><div class="contrib-count"><span>7</span></div><div class="contrib-bar" style="height:22.20px"></div><div class="contrib-label"><span>Cheng Ju</span></div></div>
    <div class="contrib-item" title="Susan Gruber: 7 papers"><div class="contrib-count"><span>7</span></div><div class="contrib-bar" style="height:22.20px"></div><div class="contrib-label"><span>Susan Gruber</span></div></div>
    <div class="contrib-item" title="Thomas A. Gerds: 7 papers"><div class="contrib-count"><span>7</span></div><div class="contrib-bar" style="height:22.20px"></div><div class="contrib-label"><span>Thomas A. Gerds</span></div></div>
    <div class="contrib-item" title="Wenxin Zhang: 6 papers"><div class="contrib-count"><span>6</span></div><div class="contrib-bar" style="height:19.02px"></div><div class="contrib-label"><span>Wenxin Zhang</span></div></div>
    <div class="contrib-item" title="Hana Lee: 5 papers"><div class="contrib-count"><span>5</span></div><div class="contrib-bar" style="height:15.85px"></div><div class="contrib-label"><span>Hana Lee</span></div></div>
    <div class="contrib-item" title="Jens Magelund Tarp: 5 papers"><div class="contrib-count"><span>5</span></div><div class="contrib-bar" style="height:15.85px"></div><div class="contrib-label"><span>Jens Magelund Tarp</span></div></div>
    <div class="contrib-item" title="Jonathan Levy: 5 papers"><div class="contrib-count"><span>5</span></div><div class="contrib-bar" style="height:15.85px"></div><div class="contrib-label"><span>Jonathan Levy</span></div></div>
    <div class="contrib-item" title="Lars van der Laan: 5 papers"><div class="contrib-count"><span>5</span></div><div class="contrib-bar" style="height:15.85px"></div><div class="contrib-label"><span>Lars van der Laan</span></div></div>
    <div class="contrib-item" title="Lina M. Montoya: 5 papers"><div class="contrib-count"><span>5</span></div><div class="contrib-bar" style="height:15.85px"></div><div class="contrib-label"><span>Lina M. Montoya</span></div></div>
    <div class="contrib-item" title="Mireille E. Schnitzer: 5 papers"><div class="contrib-count"><span>5</span></div><div class="contrib-bar" style="height:15.85px"></div><div class="contrib-label"><span>Mireille E. Schnitzer</span></div></div>
    <div class="contrib-item" title="Oleg Sofrygin: 5 papers"><div class="contrib-count"><span>5</span></div><div class="contrib-bar" style="height:15.85px"></div><div class="contrib-label"><span>Oleg Sofrygin</span></div></div>
    <div class="contrib-item" title="Aurélien F. Bibaut: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Aurélien F. Bibaut</span></div></div>
    <div class="contrib-item" title="David McCoy: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>David McCoy</span></div></div>
    <div class="contrib-item" title="Herbert Susmann: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Herbert Susmann</span></div></div>
    <div class="contrib-item" title="Kajsa Kvist: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Kajsa Kvist</span></div></div>
    <div class="contrib-item" title="Kara E. Rudolph: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Kara E. Rudolph</span></div></div>
    <div class="contrib-item" title="Masahiro Kato: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Masahiro Kato</span></div></div>
    <div class="contrib-item" title="Moses R. Kamya: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Moses R. Kamya</span></div></div>
    <div class="contrib-item" title="Razieh Nabi: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Razieh Nabi</span></div></div>
    <div class="contrib-item" title="Robert W. Platt: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Robert W. Platt</span></div></div>
    <div class="contrib-item" title="Sky Qiu: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Sky Qiu</span></div></div>
    <div class="contrib-item" title="Weixin Cai: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Weixin Cai</span></div></div>
    <div class="contrib-item" title="Yi Li: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Yi Li</span></div></div>
    <div class="contrib-item" title="Zeyi Wang: 4 papers"><div class="contrib-count"><span>4</span></div><div class="contrib-bar" style="height:12.68px"></div><div class="contrib-label"><span>Zeyi Wang</span></div></div>
    <div class="contrib-item" title="Andrew Mertens: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Andrew Mertens</span></div></div>
    <div class="contrib-item" title="Anna Guo: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Anna Guo</span></div></div>
    <div class="contrib-item" title="Arthur Chatton: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Arthur Chatton</span></div></div>
    <div class="contrib-item" title="Elvin H. Geng: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Elvin H. Geng</span></div></div>
    <div class="contrib-item" title="Gabriel Chamie: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Gabriel Chamie</span></div></div>
    <div class="contrib-item" title="Giles Hooker: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Giles Hooker</span></div></div>
    <div class="contrib-item" title="Jeremy R. Coyle: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Jeremy R. Coyle</span></div></div>
    <div class="contrib-item" title="Jessica M. Franklin: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Jessica M. Franklin</span></div></div>
    <div class="contrib-item" title="Joshua R. Nugent: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Joshua R. Nugent</span></div></div>
    <div class="contrib-item" title="Joshua Schwab: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Joshua Schwab</span></div></div>
    <div class="contrib-item" title="Junming Shi: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Junming Shi</span></div></div>
    <div class="contrib-item" title="Margarita Moreno-Betancur: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Margarita Moreno-Betancur</span></div></div>
    <div class="contrib-item" title="Michael Rosenblum: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Michael Rosenblum</span></div></div>
    <div class="contrib-item" title="Michael Schomaker: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Michael Schomaker</span></div></div>
    <div class="contrib-item" title="Miguel Angel Luque-Fernandez: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Miguel Angel Luque-Fernandez</span></div></div>
    <div class="contrib-item" title="Nima S. Hejazi: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Nima S. Hejazi</span></div></div>
    <div class="contrib-item" title="Richard Wyss: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Richard Wyss</span></div></div>
    <div class="contrib-item" title="Romain Pirracchio: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Romain Pirracchio</span></div></div>
    <div class="contrib-item" title="Sebastian Schneeweiss: 3 papers"><div class="contrib-count"><span>3</span></div><div class="contrib-bar" style="height:9.51px"></div><div class="contrib-label"><span>Sebastian Schneeweiss</span></div></div>
    <div class="contrib-item" title="Akash Agrawal: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Akash Agrawal</span></div></div>
    <div class="contrib-item" title="Alexander P. Keil: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Alexander P. Keil</span></div></div>
    <div class="contrib-item" title="Anders Munch: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Anders Munch</span></div></div>
    <div class="contrib-item" title="Audrey Renson: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Audrey Renson</span></div></div>
    <div class="contrib-item" title="Bin Hu: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Bin Hu</span></div></div>
    <div class="contrib-item" title="Brian D. Williamson: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Brian D. Williamson</span></div></div>
    <div class="contrib-item" title="Caleb H. Miles: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Caleb H. Miles</span></div></div>
    <div class="contrib-item" title="Camille Maringe: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Camille Maringe</span></div></div>
    <div class="contrib-item" title="Carina Marquez: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Carina Marquez</span></div></div>
    <div class="contrib-item" title="Carlos García Meixide: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Carlos García Meixide</span></div></div>
    <div class="contrib-item" title="Chi Zhang: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Chi Zhang</span></div></div>
    <div class="contrib-item" title="Christopher McComb: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Christopher McComb</span></div></div>
    <div class="contrib-item" title="Diane V. Havlir: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Diane V. Havlir</span></div></div>
    <div class="contrib-item" title="Douglas E. Faries: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Douglas E. Faries</span></div></div>
    <div class="contrib-item" title="Edwin C. H. Fong: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Edwin C. H. Fong</span></div></div>
    <div class="contrib-item" title="Edwin D. Charlebois: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Edwin D. Charlebois</span></div></div>
    <div class="contrib-item" title="Elijah Kakande: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Elijah Kakande</span></div></div>
    <div class="contrib-item" title="Emilie Højbjerre-Frandsen: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Emilie Højbjerre-Frandsen</span></div></div>
    <div class="contrib-item" title="Geoffrey Ecoto: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Geoffrey Ecoto</span></div></div>
    <div class="contrib-item" title="Haodong Li: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Haodong Li</span></div></div>
    <div class="contrib-item" title="Ilya Lipkovich: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Ilya Lipkovich</span></div></div>
    <div class="contrib-item" title="James Ayieko: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>James Ayieko</span></div></div>
    <div class="contrib-item" title="Jane Kabami: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Jane Kabami</span></div></div>
    <div class="contrib-item" title="Jennifer Ahern: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Jennifer Ahern</span></div></div>
    <div class="contrib-item" title="Jiayi Ji: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Jiayi Ji</span></div></div>
    <div class="contrib-item" title="Jie Chen: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Jie Chen</span></div></div>
    <div class="contrib-item" title="Jie Zhu: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Jie Zhu</span></div></div>
    <div class="contrib-item" title="John B Buse: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>John B Buse</span></div></div>
    <div class="contrib-item" title="John B. Carlin: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>John B. Carlin</span></div></div>
    <div class="contrib-item" title="John Concato: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>John Concato</span></div></div>
    <div class="contrib-item" title="Kaiwen Hou: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Kaiwen Hou</span></div></div>
    <div class="contrib-item" title="Karla DiazOrdaz: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Karla DiazOrdaz</span></div></div>
    <div class="contrib-item" title="Kirsten E. Landsiedel: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Kirsten E. Landsiedel</span></div></div>
    <div class="contrib-item" title="Kyra Gan: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Kyra Gan</span></div></div>
    <div class="contrib-item" title="Lauren Eyler Dang: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Lauren Eyler Dang</span></div></div>
    <div class="contrib-item" title="Liangyuan Hu: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Liangyuan Hu</span></div></div>
    <div class="contrib-item" title="Marco Carone: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Marco Carone</span></div></div>
    <div class="contrib-item" title="Matthew J. Smith: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Matthew J. Smith</span></div></div>
    <div class="contrib-item" title="Michael Hudgens: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Michael Hudgens</span></div></div>
    <div class="contrib-item" title="Michael R. Kosorok: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Michael R. Kosorok</span></div></div>
    <div class="contrib-item" title="Nerissa Nance: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Nerissa Nance</span></div></div>
    <div class="contrib-item" title="Nicholas T. Williams: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Nicholas T. Williams</span></div></div>
    <div class="contrib-item" title="Noemi Kreif: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Noemi Kreif</span></div></div>
    <div class="contrib-item" title="Paul N Zivich: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Paul N Zivich</span></div></div>
    <div class="contrib-item" title="Peter B. Gilbert: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Peter B. Gilbert</span></div></div>
    <div class="contrib-item" title="Rachel Abbott: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Rachel Abbott</span></div></div>
    <div class="contrib-item" title="Samuel D. Lendle: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Samuel D. Lendle</span></div></div>
    <div class="contrib-item" title="Shu Yang: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Shu Yang</span></div></div>
    <div class="contrib-item" title="Stijn Vansteelandt: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Stijn Vansteelandt</span></div></div>
    <div class="contrib-item" title="Thomas A. Odeny: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Thomas A. Odeny</span></div></div>
    <div class="contrib-item" title="Wenjing Zheng: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Wenjing Zheng</span></div></div>
    <div class="contrib-item" title="Yan Liu: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Yan Liu</span></div></div>
    <div class="contrib-item" title="Yong Chen: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Yong Chen</span></div></div>
    <div class="contrib-item" title="Yunzhe Zhou: 2 papers"><div class="contrib-count"><span>2</span></div><div class="contrib-bar" style="height:6.34px"></div><div class="contrib-label"><span>Yunzhe Zhou</span></div></div>
  </div>
</div>
```
...
<!-- contributor-chart:end -->

Click a paper to view authors, keywords, and abstract.

<details>

<summary><strong>2026-02-19 — genriesz: A Python Package for Automatic Debiased Machine Learning with Generalized Riesz Regression</strong></summary>

**Authors**: Masahiro Kato\
**Link**: [arXiv:2602.17543v1](https://arxiv.org/abs/2602.17543v1)\
**Keywords**: tmle
...
<summary><strong>2026-02-18 — HAL-MLE Log-Splines Density Estimation (Part I: Univariate)</strong></summary>

**Authors**: Yilong Hou, Zhengpu Zhao, Yi Li, Mark van der Laan\
**Link**: [arXiv:2602.16259v1](https://arxiv.org/abs/2602.16259v1)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2026-02-12 — Deep Doubly Debiased Longitudinal Effect Estimation with ICE G-Computation</strong></summary>

**Authors**: Wenxin Chen, Weishen Pan, Kyra Gan, Fei Wang\
**Link**: [arXiv:2602.12379v1](https://arxiv.org/abs/2602.12379v1)\
**Keywords**: tmle, targeted minimum loss-based estimation
...
<summary><strong>2026-02-11 — Highly Adaptive Principal Component Regression</strong></summary>

**Authors**: Mingxun Wang, Alejandro Schuler, Mark van der Laan, Carlos García Meixide\
**Link**: [arXiv:2602.10613v1](https://arxiv.org/abs/2602.10613v1)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2026-01-12 — A Unified Framework for Debiased Machine Learning: Riesz Representer Fitting under Bregman Divergence</strong></summary>

**Authors**: Masahiro Kato\
**Link**: [arXiv:2601.07752v3](https://arxiv.org/abs/2601.07752v3)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2026-01-09 — A Targeted Learning Framework for Estimating Restricted Mean Survival Time Difference using Pseudo-observations</strong></summary>

**Authors**: Man Jin, Yixin Fang\
**Link**: [arXiv:2601.06296v2](https://arxiv.org/abs/2601.06296v2)\
**Keywords**: tmle, targeted learning
...
<summary><strong>2026-01-09 — Estimating optimal interpretable individualized treatment regimes from a classification perspective using adaptive LASSO</strong></summary>

**Authors**: Yunshu Zhang, Shu Yang, Wendy Ye, Ilya Lipkovich, Douglas E. Faries\
**Link**: [arXiv:2601.05875v1](https://arxiv.org/abs/2601.05875v1)\
...
<summary><strong>2025-12-26 — Targeted learning via probabilistic subpopulation matching</strong></summary>

**Authors**: Xiaokang Liu, Jie Hu, Naimin Jing, Yang Ning, Cheng Yong Tang, Runze Li, Yong Chen\
**Link**: [arXiv:2512.21840v1](https://arxiv.org/abs/2512.21840v1)\
...
<summary><strong>2025-12-22 — Causal Inference with the "Napkin Graph"</strong></summary>

**Authors**: Anna Guo, David Benkeser, Razieh Nabi\
**Link**: [arXiv:2512.19861v1](https://arxiv.org/abs/2512.19861v1)\
...
<summary><strong>2025-12-15 — Machine learning to optimize precision in the analysis of randomized trials: A journey in pre-specified, yet data-adaptive learning</strong></summary>

**Authors**: Laura B. Balzer, Mark J. van der Laan, Maya L. Petersen\
**Link**: [arXiv:2512.13610v1](https://arxiv.org/abs/2512.13610v1)\
**Keywords**: tmle
...
<summary><strong>2025-11-24 — What Drives Cross-lingual Ranking? Retrieval Approaches with Multilingual Language Models</strong></summary>

**Authors**: Roksana Goworek, Olivia Macmillan-Scott, Eda B. Özyiğit\
**Link**: [arXiv:2511.19324v1](https://arxiv.org/abs/2511.19324v1)\
**Keywords**: targeted learning
...
<summary><strong>2025-11-19 — Hazard-Based Targeted Maximum Likelihood Estimation for Survival in Resampling Designs</strong></summary>

**Authors**: Kirsten E. Landsiedel, Rachael V. Phillips, Maya L. Petersen, Mark J. van der Laan\
**Link**: [arXiv:2511.15045v1](https://arxiv.org/abs/2511.15045v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-11-10 — Causal Inference for Network Autoregression Model: A Targeted Minimum Loss Estimation Approach</strong></summary>

**Authors**: Yong Wu, Shuyuan Wu, Xinwei Sun, Xuening Zhu\
**Link**: [arXiv:2511.06652v2](https://arxiv.org/abs/2511.06652v2)\
**Keywords**: tmle
...
<summary><strong>2025-11-02 — From Path Coefficients to Targeted Estimands: A Comparison of Structural Equation Models (SEM) and Targeted Maximum Likelihood Estimation (TMLE)</strong></summary>

**Authors**: Junjie Ma, Xiaoya Zhang, Guangye He, Yuting Han, Ting Ge, Feng Ji\
**Link**: [arXiv:2511.01040v2](https://arxiv.org/abs/2511.01040v2)\
**Keywords**: tmle, targeted maximum likelihood, targeted learning
...
<summary><strong>2025-10-30 — A Unified Theory for Causal Inference: Direct Debiased Machine Learning via Bregman-Riesz Regression</strong></summary>

**Authors**: Masahiro Kato\
**Link**: [arXiv:2510.26783v1](https://arxiv.org/abs/2510.26783v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-10-27 — Nonparametric Identification and Estimation of Ratios of Multi-Category Means under Preferential Sampling</strong></summary>

**Authors**: Grant Hopkins, Sarah Teichman, Ellen Graham, Amy D Willis\
**Link**: [arXiv:2510.23920v1](https://arxiv.org/abs/2510.23920v1)\
**Keywords**: None listed
...
<summary><strong>2025-10-27 — Direct Debiased Machine Learning via Bregman Divergence Minimization</strong></summary>

**Authors**: Masahiro Kato\
**Link**: [arXiv:2510.23534v2](https://arxiv.org/abs/2510.23534v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-10-25 — Causal Effect Estimation with TMLE: Handling Missing Data and Near-Violations of Positivity</strong></summary>

**Authors**: Christoph Wiederkehr, Christian Heumann, Michael Schomaker\
**Link**: [arXiv:2510.22202v1](https://arxiv.org/abs/2510.22202v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-10-19 — Causal inference for calibrated scaling interventions on time-to-event processes</strong></summary>

**Authors**: Helene Charlotte Wiese Rytgaard, Mark van der Laan\
**Link**: [arXiv:2510.16798v2](https://arxiv.org/abs/2510.16798v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-10-18 — Estimate Time-Varying Exposure Effects via Ensemble Learning-based Marginal Structural Model with Application to Adolescent Cognitive Development Study</strong></summary>

**Authors**: Zhiwei Zhao, Chixiang Chen, Shuo Chen\
**Link**: [arXiv:2510.16298v1](https://arxiv.org/abs/2510.16298v1)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2025-09-29 — Reinforcement Mid-Training</strong></summary>

**Authors**: Yijun Tian, Shaoyu Chen, Zhichao Xu, Yawei Wang, Jinhe Bi, Peng Han, Wei Wang\
**Link**: [arXiv:2509.24375v1](https://arxiv.org/abs/2509.24375v1)\
**Keywords**: targeted learning
...
<summary><strong>2025-09-24 — Non-overlap Average Treatment Effect Bounds</strong></summary>

**Authors**: Herbert P. Susmann, Alec McClean, Iván Díaz\
**Link**: [arXiv:2509.20206v1](https://arxiv.org/abs/2509.20206v1)\
**Keywords**: None listed
...
<summary><strong>2025-09-03 — The super learner for time-to-event outcomes: A tutorial</strong></summary>

**Authors**: Ruth H. Keogh, Karla Diaz-Ordaz, Nan van Geloven, Jon Michael Gran, Kamaryn T. Tanner\
**Link**: [arXiv:2509.03315v2](https://arxiv.org/abs/2509.03315v2)\
**Keywords**: super learner
...
<summary><strong>2025-08-13 — Linking GFAP Levels to Speech Anomalies in Acute Brain Injury: A Simulation Based Study</strong></summary>

**Authors**: Shamaley Aravinthan, Bin Hu\
**Link**: [arXiv:2508.10130v1](https://arxiv.org/abs/2508.10130v1)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2025-08-13 — Developing an Inhaled NEU1 Inhibitor for Cystic Fibrosis via Pharmacokinetic and Biophysical Modeling</strong></summary>

**Authors**: Yousra Hassan Alsaad Almeshale, Abdulelah Hassan Almeshali, Omar Alsaddique, Noura Jandali, Nadeen Garaween, Bin Hu\
**Link**: [arXiv:2508.10082v1](https://arxiv.org/abs/2508.10082v1)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2025-08-12 — Efficient Statistical Estimation for Sequential Adaptive Experiments with Implications for Adaptive Designs</strong></summary>

**Authors**: Wenxin Zhang, Mark van der Laan\
**Link**: [arXiv:2508.09135v2](https://arxiv.org/abs/2508.09135v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-08-12 — Debiased machine learning for combining probability and non-probability survey data</strong></summary>

**Authors**: Shaun Seaman\
**Link**: [arXiv:2508.08948v2](https://arxiv.org/abs/2508.08948v2)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2025-07-31 — "Within-trial" prognostic score adjustment is targeted maximum likelihood estimation</strong></summary>

**Authors**: Emilie Højbjerre-Frandsen, Alejandro Schuler\
**Link**: [arXiv:2507.23446v2](https://arxiv.org/abs/2507.23446v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-07-21 — Bayesian implementation of Targeted Maximum Likelihood Estimation for uncertainty quantification in causal effect estimation</strong></summary>

**Authors**: Saideep Nannapaneni, Joseph Sakaya, Kyle Caron, Pedro HM Albuquerque, Zaid Tashman\
**Link**: [arXiv:2507.15909v1](https://arxiv.org/abs/2507.15909v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-07-16 — Targeted Deep Architectures: A TMLE-Based Framework for Robust Causal Inference in Neural Networks</strong></summary>

**Authors**: Yi Li, David Mccoy, Nolan Gunter, Kaitlyn Lee, Alejandro Schuler, Mark van der Laan\
**Link**: [arXiv:2507.12435v1](https://arxiv.org/abs/2507.12435v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-07-15 — Constructing targeted minimum loss/maximum likelihood estimators: a simple illustration to build intuition</strong></summary>

**Authors**: Rachael K. Ross, Lina M. Montoya, Dana E. Goin, Ivan Diaz, Audrey Renson\
**Link**: [arXiv:2507.11680v1](https://arxiv.org/abs/2507.11680v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-07-15 — Try Harder: Hard Sample Generation and Learning for Clothes-Changing Person Re-ID</strong></summary>

**Authors**: Hankun Liu, Yujian Zhao, Guanglin Niu\
**Link**: [arXiv:2507.11119v1](https://arxiv.org/abs/2507.11119v1)\
**Keywords**: targeted learning
...
<summary><strong>2025-07-15 — Constructing Confidence Intervals for Infinite-Dimensional Functional Parameters by Highly Adaptive Lasso</strong></summary>

**Authors**: Wenxin Zhang, Junming Shi, Alan Hubbard, Mark van der Laan\
**Link**: [arXiv:2507.10511](https://arxiv.org/abs/2507.10511)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2025-07-14 — Constructing Confidence Intervals for Infinite-Dimensional Functional Parameters by Highly Adaptive Lasso</strong></summary>

**Authors**: Wenxin Zhang, Junming Shi, Alan Hubbard, Mark van der Laan\
**Link**: [arXiv:2507.10511v3](https://arxiv.org/abs/2507.10511v3)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2025-06-26 — Estimating Average Causal Effects with Incomplete Exposure and Confounders</strong></summary>

**Authors**: Lan Wen, Glen McGee\
**Link**: [arXiv:2506.21786v1](https://arxiv.org/abs/2506.21786v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-06-26 — Causal inference via implied interventions</strong></summary>

**Authors**: Carlos García Meixide, Mark J. van der Laan\
**Link**: [arXiv:2506.21501v1](https://arxiv.org/abs/2506.21501v1)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2025-06-20 — Regularized Targeted Maximum Likelihood Estimation in Highly Adaptive Lasso Implied Working Models</strong></summary>

**Authors**: Yi Li, Sky Qiu, Zeyi Wang, Mark van der Laan\
**Link**: [arXiv:2506.17214v1](https://arxiv.org/abs/2506.17214v1)\
**Keywords**: tmle, targeted maximum likelihood, highly adaptive lasso
...
<summary><strong>2025-06-06 — When Measurement Mediates the Effect of Interest</strong></summary>
...
**Link**: [arXiv:2506.06267v2](https://arxiv.org/abs/2506.06267v2)\
**Keywords**: tmle, targeted minimum loss-based estimation
...
<summary><strong>2025-06-03 — Causal Inference with Missing Exposures and Missing Outcomes</strong></summary>
...
**Link**: [arXiv:2506.03336v2](https://arxiv.org/abs/2506.03336v2)\
**Keywords**: tmle, super learner
...
<summary><strong>2025-06-03 — KARE-RAG: Knowledge-Aware Refinement and Enhancement for RAG</strong></summary>

**Authors**: Yongjian Li, HaoCheng Chu, Yukun Yan, Zhenghao Liu, Shi Yu, Zheni Zeng, Ruobing Wang, Sen Song, Zhiyuan Liu, Maosong Sun\
**Link**: [arXiv:2506.02503v1](https://arxiv.org/abs/2506.02503v1)\
**Keywords**: targeted learning
...
<summary><strong>2025-06-03 — Co-Evidential Fusion with Information Volume for Medical Image Segmentation</strong></summary>

**Authors**: Yuanpeng He, Lijian Li, Tianxiang Zhan, Chi-Man Pun, Wenpin Jiao, Zhi Jin\
**Link**: [arXiv:2506.02492v1](https://arxiv.org/abs/2506.02492v1)\
**Keywords**: targeted learning
...
<summary><strong>2025-05-27 — Towards Objective Fine-tuning: How LLMs' Prior Knowledge Causes Potential Poor Calibration?</strong></summary>

**Authors**: Ziming Wang, Zeyu Shi, Haoyi Zhou, Shiqi Gao, Qingyun Sun, Jianxin Li\
**Link**: [arXiv:2505.20903v1](https://arxiv.org/abs/2505.20903v1)\
**Keywords**: targeted learning
...
<summary><strong>2025-05-20 — Semi-parametric efficient estimation of small genetic effects in large-scale population cohorts</strong></summary>
...
**Link**: [arXiv:2505.14675v1](https://arxiv.org/abs/2505.14675v1)\
**Keywords**: tmle
...
<summary><strong>2025-05-15 — Targeted Learning Estimation of Sampling Variance for Improved Inference</strong></summary>

**Authors**: Yunwen Ji, Mark van der Laan, Alan Hubbard\
**Link**: [arXiv:2505.10624v1](https://arxiv.org/abs/2505.10624v1)\
**Keywords**: targeted maximum likelihood, targeted learning
...
<summary><strong>2025-05-15 — Ordered-subsets Multi-diffusion Model for Sparse-view CT Reconstruction</strong></summary>

**Authors**: Pengfei Yu, Bin Huang, Minghui Zhang, Weiwen Wu, Shaoyu Wang, Qiegen Liu\
**Link**: [arXiv:2505.09985v1](https://arxiv.org/abs/2505.09985v1)\
**Keywords**: targeted learning
...
<summary><strong>2025-05-01 — On the Mechanistic Interpretability of Neural Networks for Causality in Bio-statistics</strong></summary>

**Authors**: Jean-Baptiste A. Conan\
**Link**: [arXiv:2505.00555v1](https://arxiv.org/abs/2505.00555v1)\
**Keywords**: tmle, targeted minimum loss-based estimation
...
<summary><strong>2025-04-30 — Assessing Racial Disparities in Healthcare Expenditures via Mediator Distribution Shifts</strong></summary>

**Authors**: Xiaxian Ou, Xinwei He, David Benkeser, Razieh Nabi\
**Link**: [arXiv:2504.21688v2](https://arxiv.org/abs/2504.21688v2)\
**Keywords**: super learner
...
<summary><strong>2025-04-22 — Causal machine learning for high-dimensional mediation analysis using interventional effects mapped to a target trial</strong></summary>

**Authors**: Tong Chen, Stijn Vansteelandt, David Burgner, Toby Mansell, Margarita Moreno-Betancur\
**Link**: [arXiv:2504.15834v1](https://arxiv.org/abs/2504.15834v1)\
**Keywords**: None listed
...
<summary><strong>2025-04-04 — Weak instrumental variables due to nonlinearities in panel data: A Super Learner Control Function estimator</strong></summary>

**Authors**: Monika Avila-Marquez\
**Link**: [arXiv:2504.03228v8](https://arxiv.org/abs/2504.03228v8)\
**Keywords**: super learner
...
<summary><strong>2025-04-03 — QID: Efficient Query-Informed ViTs in Data-Scarce Regimes for OCR-free Visual Document Understanding</strong></summary>

**Authors**: Binh M. Le, Shaoyuan Xu, Jinmiao Fu, Zhishen Huang, Moyan Li, Yanhui Guo, Hongdong Li, Sameera Ramasinghe, Bryan Wang\
**Link**: [arXiv:2504.02971v2](https://arxiv.org/abs/2504.02971v2)\
**Keywords**: targeted learning
...
<summary><strong>2025-03-23 — Adaptive Multi-Fidelity Reinforcement Learning for Variance Reduction in Engineering Design Optimization</strong></summary>

**Authors**: Akash Agrawal, Christopher McComb\
**Link**: [arXiv:2503.18229v1](https://arxiv.org/abs/2503.18229v1)\
**Keywords**: targeted learning
...
<summary><strong>2025-02-23 — Predictive Modeling: BIM Command Recommendation Based on Large-scale Usage Logs</strong></summary>

**Authors**: Changyu Du, Zihan Deng, Stavros Nousias, André Borrmann\
**Link**: [arXiv:2504.05319v2](https://arxiv.org/abs/2504.05319v2)\
**Keywords**: targeted learning
...
<summary><strong>2025-02-22 — Understanding the Emergence of Multimodal Representation Alignment</strong></summary>

**Authors**: Megan Tjandrasuwita, Chanakya Ekbote, Liu Ziyin, Paul Pu Liang\
**Link**: [arXiv:2502.16282v2](https://arxiv.org/abs/2502.16282v2)\
**Keywords**: targeted learning
...
<summary><strong>2025-02-11 — Cost Effectiveness Analyses for Sequential Multiple Assignment Randomized Trials</strong></summary>

**Authors**: Lina M. Montoya, Elvin H. Geng, Harriet F. Adhiambo, Eliud Akama, Starley B. Shade, Assurah Elly, Thomas Odeny, Maya L. Petersen\
**Link**: [arXiv:2502.07973v1](https://arxiv.org/abs/2502.07973v1)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2025-02-06 — Targeted Learning for Data Fairness</strong></summary>

**Authors**: Alexander Asemota, Giles Hooker\
**Link**: [arXiv:2502.04309v1](https://arxiv.org/abs/2502.04309v1)\
**Keywords**: targeted learning
...
<summary><strong>2025-01-31 — Score-Preserving Targeted Maximum Likelihood Estimation</strong></summary>

**Authors**: Noel Pimentel, Alejandro Schuler, Mark van der Laan\
**Link**: [arXiv:2502.00200v1](https://arxiv.org/abs/2502.00200v1)\
**Keywords**: tmle, targeted maximum likelihood, highly adaptive lasso
...
<summary><strong>2025-01-30 — U-aggregation: Unsupervised Aggregation of Multiple Learning Algorithms</strong></summary>

**Authors**: Rui Duan\
**Link**: [arXiv:2501.18084v1](https://arxiv.org/abs/2501.18084v1)\
**Keywords**: super learner
...
<summary><strong>2025-01-29 — An Estimator-Robust Design for Augmenting Randomized Controlled Trial with External Real-World Data</strong></summary>

**Authors**: Sky Qiu, Jens Tarp, Andrew Mertens, Mark van der Laan\
**Link**: [arXiv:2501.17835v1](https://arxiv.org/abs/2501.17835v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-01-27 — LLM-powered Multi-agent Framework for Goal-oriented Learning in Intelligent Tutoring System</strong></summary>

**Authors**: Tianfu Wang, Yi Zhan, Jianxun Lian, Zhengyu Hu, Nicholas Jing Yuan, Qi Zhang, Xing Xie, Hui Xiong\
**Link**: [arXiv:2501.15749v1](https://arxiv.org/abs/2501.15749v1)\
**Keywords**: targeted learning
...
<summary><strong>2025-01-18 — Adaptive-TMLE for the Average Treatment Effect based on Randomized Controlled Trial Augmented with Real-World Data</strong></summary>

**Authors**: Mark van der Laan, Sky Qiu, Jens Magelund Tarp, Lars van der Laan\
**Link**: [arXiv:2405.07186v2](https://arxiv.org/abs/2405.07186v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2025-01-17 — Cheap Subsampling bootstrap confidence intervals for fast and robust inference</strong></summary>

**Authors**: Johan Sebastian Ohlendorff, Anders Munch, Kathrine Kold Sørensen, Thomas Alexander Gerds\
**Link**: [arXiv:2501.10289v3](https://arxiv.org/abs/2501.10289v3)\
**Keywords**: None listed
...
<summary><strong>2025-01-10 — Technical Note: Targeted Maximum Likelihood Estimator for an ATE Standardized for New Target Population</strong></summary>

**Authors**: Mark van der Laan, Susan Gruber\
**Link**: [arXiv:2501.06381v1](https://arxiv.org/abs/2501.06381v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2024-12-20 — Bayesian Optimization for Unknown Cost-Varying Variable Subsets with No-Regret Costs</strong></summary>

**Authors**: Vu Viet Hoang, Quoc Anh Hoang Nguyen, Hung Tran The\
**Link**: [arXiv:2412.15863v1](https://arxiv.org/abs/2412.15863v1)\
**Keywords**: targeted learning
...
<summary><strong>2024-12-19 — Assessing treatment effects in observational data with missing confounders: A comparative study of practical doubly-robust and traditional missing data methods</strong></summary>
...
**Link**: [arXiv:2412.15012v2](https://arxiv.org/abs/2412.15012v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2024-12-13 — What if we had built a prediction model with a survival super learner instead of a Cox model 10 years ago?</strong></summary>

**Authors**: Arthur Chatton, Émilie Pilote, Kevin Assob Feugo, Héloïse Cardinal, Robert W. Platt, Mireille E Schnitzer\
**Link**: [arXiv:2412.10252v1](https://arxiv.org/abs/2412.10252v1)\
**Keywords**: super learner
...
<summary><strong>2024-12-11 — Bootstrapping Heterogeneous Graph Representation Learning via Large Language Models: A Generalized Approach</strong></summary>

**Authors**: Hang Gao, Chenhao Zhang, Fengge Wu, Junsuo Zhao, Changwen Zheng, Huaping Liu\
**Link**: [arXiv:2412.08038v3](https://arxiv.org/abs/2412.08038v3)\
**Keywords**: targeted learning
...
<summary><strong>2024-12-06 — Estimating the treatment effect over time under general interference through deep learner integrated TMLE</strong></summary>

**Authors**: Suhan Guo, Furao Shen, Ni Li\
**Link**: [arXiv:2412.04799v1](https://arxiv.org/abs/2412.04799v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2024-11-24 — Unveiling the Superior Paradigm: A Comparative Study of Source-Free Domain Adaptation and Unsupervised Domain Adaptation</strong></summary>

**Authors**: Fan Wang, Zhongyi Han, Xingbo Liu, Xin Gao, Yilong Yin\
**Link**: [arXiv:2411.15844v1](https://arxiv.org/abs/2411.15844v1)\
**Keywords**: targeted learning
...
<summary><strong>2024-11-22 — Double Machine Learning for Adaptive Causal Representation in High-Dimensional Data</strong></summary>

**Authors**: Lynda Aouar, Han Yu\
**Link**: [arXiv:2411.14665v1](https://arxiv.org/abs/2411.14665v1)\
**Keywords**: super learner
...
<summary><strong>2024-11-16 — Adaptive Learning of Design Strategies over Non-Hierarchical Multi-Fidelity Models via Policy Alignment</strong></summary>

**Authors**: Akash Agrawal, Christopher McComb\
**Link**: [arXiv:2411.10841v1](https://arxiv.org/abs/2411.10841v1)\
**Keywords**: targeted learning
...
<summary><strong>2024-11-15 — G-computation for increasing performances of clinical trials with individual randomization and binary response</strong></summary>

**Authors**: Joe de Keizer, Rémi Lenain, Raphaël Porcher, Sarah Zoha, Arthur Chatton, Yohann Foucher\
**Link**: [arXiv:2411.10089v1](https://arxiv.org/abs/2411.10089v1)\
**Keywords**: super learner
...
<summary><strong>2024-11-12 — Targeted Maximum Likelihood Estimation for Integral Projection Models in Population Ecology</strong></summary>

**Authors**: Yunzhe Zhou, Giles Hooker\
**Link**: [arXiv:2411.08150v1](https://arxiv.org/abs/2411.08150v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2024-11-04 — Targeted Learning for Variable Importance</strong></summary>

**Authors**: Xiaohan Wang, Yunzhe Zhou, Giles Hooker\
**Link**: [arXiv:2411.02221v2](https://arxiv.org/abs/2411.02221v2)\
**Keywords**: targeted learning
...
<summary><strong>2024-10-25 — trajmsm: An R package for Trajectory Analysis and Causal Modeling</strong></summary>

**Authors**: Awa Diop, Caroline Sirois, Jason R. Guertin, Mireille E. Schnitzer, James M. Brophy, Denis Talbot\
**Link**: [arXiv:2410.19682v2](https://arxiv.org/abs/2410.19682v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2024-10-24 — Doubly Robust Nonparametric Efficient Estimation for Provider Evaluation</strong></summary>

**Authors**: Herbert Susmann, Yiting Li, Mara A. McAdams-DeMarco, Iván Díaz, Wenbo Wu\
**Link**: [arXiv:2410.19073v1](https://arxiv.org/abs/2410.19073v1)\
**Keywords**: targeted minimum loss-based estimation
...
<summary><strong>2024-10-09 — Use of Real-World Data and Real-World Evidence in Rare Disease Drug Development: A Statistical Perspective</strong></summary>
...
**Link**: [arXiv:2410.06586v1](https://arxiv.org/abs/2410.06586v1)\
**Keywords**: targeted learning
...
<summary><strong>2024-09-29 — Automatic debiasing of neural networks via moment-constrained learning</strong></summary>

**Authors**: Christian L. Hines, Oliver J. Hines\
**Link**: [arXiv:2409.19777v2](https://arxiv.org/abs/2409.19777v2)\
**Keywords**: targeted learning
...
<summary><strong>2024-09-17 — Performance of Cross-Validated Targeted Maximum Likelihood Estimation</strong></summary>

**Authors**: Matthew J. Smith, Rachael V. Phillips, Camille Maringe, Miguel Angel Luque-Fernandez\
**Link**: [arXiv:2409.11265v2](https://arxiv.org/abs/2409.11265v2)\
**Keywords**: tmle, targeted maximum likelihood, super learner
...
<summary><strong>2024-09-06 — Leveraging Machine Learning for Official Statistics: A Statistical Manifesto</strong></summary>

**Authors**: Marco Puts, David Salgado, Piet Daas\
**Link**: [arXiv:2409.04365v1](https://arxiv.org/abs/2409.04365v1)\
**Keywords**: tmle
...
<summary><strong>2024-09-06 — Average Causal Effect Estimation in DAGs with Hidden Variables: Beyond Back-Door and Front-Door Criteria</strong></summary>

**Authors**: Anna Guo, Razieh Nabi\
**Link**: [arXiv:2409.03962v2](https://arxiv.org/abs/2409.03962v2)\
**Keywords**: None listed
...
<summary><strong>2024-08-26 — Effects Among the Affected</strong></summary>

**Authors**: Lina M. Montoya, Elvin H. Geng, Michael Valancius, Michael R. Kosorok, Maya L. Petersen\
**Link**: [arXiv:2408.14691v1](https://arxiv.org/abs/2408.14691v1)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2024-08-19 — Non-Plug-In Estimators Could Outperform Plug-In Estimators: a Cautionary Note and a Diagnosis</strong></summary>

**Authors**: Hongxiang Qiu\
**Link**: [arXiv:2408.10091v1](https://arxiv.org/abs/2408.10091v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2024-08-17 — \[Invited Discussion\] Randomization Tests to Address Disruptions in Clinical Trials: A Report from the NISS Ingram Olkin Forum Series on Unplanned Clinical Trial Disruptions</strong></summary>

**Authors**: Rachael V. Phillips, Mark J. van der Laan\
**Link**: [arXiv:2408.09060v1](https://arxiv.org/abs/2408.09060v1)\
**Keywords**: targeted learning
...
<summary><strong>2024-08-13 — A comparison of methods for estimating the average treatment effect on the treated for externally controlled trials</strong></summary>

**Authors**: Huan Wang, Fei Wu, Yeh-Fong Chen\
**Link**: [arXiv:2408.07193v2](https://arxiv.org/abs/2408.07193v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2024-08-09 — A Density Ratio Super Learner</strong></summary>

**Authors**: Wencheng Wu, David Benkeser\
**Link**: [arXiv:2408.04796v1](https://arxiv.org/abs/2408.04796v1)\
**Keywords**: super learner, super learning
...
<summary><strong>2024-08-05 — An Online Meta-Level Adaptive-Design Framework with Targeted Learning Inference: Applications to Evaluating and Utilizing Surrogate Outcomes in Adaptive Designs</strong></summary>

**Authors**: Wenxin Zhang, Aaron Hudson, Maya Petersen, Mark van der Laan\
**Link**: [arXiv:2408.02667v5](https://arxiv.org/abs/2408.02667v5)\
**Keywords**: targeted maximum likelihood, targeted learning
...
<summary><strong>2024-07-25 — Doubly Robust Targeted Estimation of Conditional Average Treatment Effects for Time-to-event Outcomes with Competing Risks</strong></summary>

**Authors**: Runjia Li, Victor B. Talisa, Chung-Chou H. Chang\
**Link**: [arXiv:2407.18389v1](https://arxiv.org/abs/2407.18389v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2024-07-04 — A fast neural hybrid Newton solver adapted to implicit methods for nonlinear dynamics</strong></summary>

**Authors**: Tianyu Jin, Georg Maierhofer, Katharina Schratz, Yang Xiang\
**Link**: [arXiv:2407.03945v3](https://arxiv.org/abs/2407.03945v3)\
**Keywords**: targeted learning
...
<summary><strong>2024-06-16 — Data-Adaptive Identification of Effect Modifiers through Stochastic Shift Interventions and Cross-Validated Targeted Learning</strong></summary>

**Authors**: David McCoy, Wenxin Zhang, Alan Hubbard, Mark van der Laan, Alejandro Schuler\
**Link**: [arXiv:2406.10792v2](https://arxiv.org/abs/2406.10792v2)\
**Keywords**: tmle, targeted minimum loss-based estimation, targeted learning
...
<summary><strong>2024-06-09 — HAL-Based Plug-in Estimation with Pointwise Asymptotic Normality of the Causal Dose-Response Curve</strong></summary>

**Authors**: Junming Shi, Wenxin Zhang, Alan E. Hubbard, Mark van der Laan\
**Link**: [arXiv:2406.05607v4](https://arxiv.org/abs/2406.05607v4)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2024-06-06 — Causal Inference in Randomized Trials with Partial Clustering</strong></summary>

**Authors**: Joshua Nugent, Elijah Kakande, Gabriel Chamie, Jane Kabami, Asiphas Owaraganise, Diane V. Havlir, Moses Kamya, Laura Balzer\
**Link**: [arXiv:2406.04505v2](https://arxiv.org/abs/2406.04505v2)\
**Keywords**: tmle, targeted minimum loss-based estimation
...
<summary><strong>2024-05-27 — The joint survival super learner: A super learner for right-censored data</strong></summary>

**Authors**: Anders Munch, Thomas A. Gerds\
**Link**: [arXiv:2405.17259v2](https://arxiv.org/abs/2405.17259v2)\
**Keywords**: super learner, super learning
...
<summary><strong>2024-05-24 — Causal machine learning methods and use of cross-fitting in settings with high-dimensional confounding</strong></summary>

**Authors**: Susan Ellul, Stijn Vansteelandt, John B. Carlin, Margarita Moreno-Betancur\
**Link**: [arXiv:2405.15242v3](https://arxiv.org/abs/2405.15242v3)\
**Keywords**: tmle, targeted maximum likelihood, super learner
...
<summary><strong>2024-05-21 — Tutorly: Turning Programming Videos Into Apprenticeship Learning Environments with LLMs</strong></summary>

**Authors**: Wengxi Li, Roy Pea, Nick Haber, Hari Subramonyam\
**Link**: [arXiv:2405.12946v1](https://arxiv.org/abs/2405.12946v1)\
**Keywords**: targeted learning
...
<summary><strong>2024-05-15 — C-Learner: Constrained Learning for Causal Inference</strong></summary>

**Authors**: Tiffany Tianhui Cai, Yuri Fonseca, Kaiwen Hou, Hongseok Namkoong\
**Link**: [arXiv:2405.09493v6](https://arxiv.org/abs/2405.09493v6)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2024-05-14 — Exploring Graph-based Knowledge: Multi-Level Feature Distillation via Channels Relational Graph</strong></summary>

**Authors**: Zhiwei Wang, Jun Huang, Longhua Ma, Chengyu Wu, Hongyu Ma\
**Link**: [arXiv:2405.08547v2](https://arxiv.org/abs/2405.08547v2)\
**Keywords**: targeted learning
...
<summary><strong>2024-05-06 — Doubly Robust Causal Effect Estimation under Networked Interference via Targeted Learning</strong></summary>

**Authors**: Weilin Chen, Ruichu Cai, Zeqin Yang, Jie Qiao, Yuguang Yan, Zijian Li, Zhifeng Hao\
**Link**: [arXiv:2405.03342v3](https://arxiv.org/abs/2405.03342v3)\
**Keywords**: targeted learning
...
<summary><strong>2024-04-26 — Pseudo-Observations and Super Learner for the Estimation of the Restricted Mean Survival Time</strong></summary>

**Authors**: Ariane Cwiling, Vittorio Perduca, Olivier Bouaziz\
**Link**: [arXiv:2404.17211v1](https://arxiv.org/abs/2404.17211v1)\
**Keywords**: super learner
...
<summary><strong>2024-04-12 — Shifting the Paradigm: Estimating Heterogeneous Treatment Effects in the Development of Walkable Cities Design</strong></summary>

**Authors**: Jie Zhu, Bojing Liao\
**Link**: [arXiv:2404.08208v2](https://arxiv.org/abs/2404.08208v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2024-04-11 — A Multi-Expert Large Language Model Architecture for Verilog Code Generation</strong></summary>

**Authors**: Bardia Nadimi, Hao Zheng\
**Link**: [arXiv:2404.08029v1](https://arxiv.org/abs/2404.08029v1)\
**Keywords**: targeted learning
...
<summary><strong>2024-04-06 — Optimization of Lightweight Malware Detection Models For AIoT Devices</strong></summary>

**Authors**: Felicia Lo, Shin-Ming Cheng, Rafael Kaliski\
**Link**: [arXiv:2404.04567v1](https://arxiv.org/abs/2404.04567v1)\
**Keywords**: super learner
...
<summary><strong>2024-04-05 — Longitudinal Targeted Minimum Loss-based Estimation with Temporal-Difference Heterogeneous Transformer</strong></summary>

**Authors**: Toru Shirakawa, Yi Li, Yulun Wu, Sky Qiu, Yuxuan Li, Mingduo Zhao, Hiroyasu Iso, Mark van der Laan\
**Link**: [arXiv:2404.04399v2](https://arxiv.org/abs/2404.04399v2)\
**Keywords**: tmle, targeted minimum loss-based estimation
...
<summary><strong>2024-04-03 — Nonparametric efficient causal estimation of the intervention-specific expected number of recurrent events with continuous-time targeted maximum likelihood and highly adaptive lasso estimation</strong></summary>

**Authors**: Helene C. W. Rytgaard, Mark J. van der Laan\
**Link**: [arXiv:2404.01736](https://arxiv.org/abs/2404.01736)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2024-04-02 — Nonparametric efficient causal estimation of the intervention-specific expected number of recurrent events with continuous-time targeted maximum likelihood and highly adaptive lasso estimation</strong></summary>

**Authors**: Helene C. W. Rytgaard, Mark J. van der Laan\
**Link**: [arXiv:2404.01736v4](https://arxiv.org/abs/2404.01736v4)\
**Keywords**: targeted maximum likelihood, highly adaptive lasso
...
<summary><strong>2024-01-30 — Recovery and inference of causal effects with sequential adjustment for confounding and attrition</strong></summary>

**Authors**: Johan de Aguas, Johan Pensar, Tomás Varnet Pérez, Guido Biele\
**Link**: [arXiv:2401.16990v6](https://arxiv.org/abs/2401.16990v6)\
**Keywords**: tmle
...
<summary><strong>2024-01-08 — Two-Step Targeted Minimum-Loss Based Estimation for Non-Negative Two-Part Outcomes</strong></summary>

**Authors**: Nicholas T. Williams, Richard Liu, Katherine L. Hoffman, Sarah Forrest, Kara E. Rudolph, Iván Díaz\
**Link**: [arXiv:2401.04263v2](https://arxiv.org/abs/2401.04263v2)\
**Keywords**: tmle
...
<summary><strong>2023-12-15 — Flexible Nonparametric Inference for Causal Effects under the Front-Door Model</strong></summary>

**Authors**: Anna Guo, David Benkeser, Razieh Nabi\
**Link**: [arXiv:2312.10234v2](https://arxiv.org/abs/2312.10234v2)\
**Keywords**: None listed
...
<summary><strong>2023-11-30 — Geometry-Aware Normalizing Wasserstein Flows for Optimal Causal Inference</strong></summary>

**Authors**: Kaiwen Hou\
**Link**: [arXiv:2311.18826v4](https://arxiv.org/abs/2311.18826v4)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2023-11-25 — Modelling wildland fire burn severity in California using a spatial Super Learner approach</strong></summary>
...
**Link**: [arXiv:2311.16187v1](https://arxiv.org/abs/2311.16187v1)\
**Keywords**: super learner
...
<summary><strong>2023-11-06 — Practical considerations for variable screening in the super learner</strong></summary>

**Authors**: Brian D. Williamson, Drew King, Ying Huang\
**Link**: [arXiv:2311.03313v2](https://arxiv.org/abs/2311.03313v2)\
**Keywords**: super learner
...
<summary><strong>2023-10-30 — Quantile Super Learning for independent and online settings with application to solar power forecasting</strong></summary>

**Authors**: Herbert Susmann, Antoine Chambaz\
**Link**: [arXiv:2310.19343v1](https://arxiv.org/abs/2310.19343v1)\
**Keywords**: super learning
...
<summary><strong>2023-10-29 — concrete: Targeted Estimation of Survival and Competing Risks in Continuous Time</strong></summary>

**Authors**: David Chen, Helene C. W. Rytgaard, Edwin C. H. Fong, Jens M. Tarp, Maya L. Petersen, Mark J. van der Laan, Thomas A. Gerds\
**Link**: [arXiv:2310.19197v2](https://arxiv.org/abs/2310.19197v2)\
**Keywords**: tmle, targeted maximum likelihood, super learner
...
<summary><strong>2023-10-12 — Personalised dynamic super learning: an application in predicting hemodiafiltration convection volumes</strong></summary>

**Authors**: Arthur Chatton, Michèle Bally, Renée Lévesque, Ivana Malenica, Robert W. Platt, Mireille E. Schnitzer\
**Link**: [arXiv:2310.08479v2](https://arxiv.org/abs/2310.08479v2)\
**Keywords**: super learner, super learning
...
<summary><strong>2023-10-05 — Animatable Virtual Humans: Learning pose-dependent human representations in UV space for interactive performance synthesis</strong></summary>

**Authors**: Wieland Morgenstern, Milena T. Bagdasarian, Anna Hilsmann, Peter Eisert\
**Link**: [arXiv:2310.03615v1](https://arxiv.org/abs/2310.03615v1)\
**Keywords**: targeted learning
...
<summary><strong>2023-10-05 — Applying the causal roadmap to longitudinal national Danish registry data: a case study of second-line diabetes medication and dementia</strong></summary>

**Authors**: Nerissa Nance, Andrew Mertens, Thomas Gerds, Zeyi Wang, Christian Torp-Pedersen, Mark van der Laan, Kajsa Kvist, Theis Lange, Bochra Zareini, Maya Petersen\
**Link**: [arXiv:2310.03235v2](https://arxiv.org/abs/2310.03235v2)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2023-09-23 — Targeted Learning on Variable Importance Measure for Heterogeneous Treatment Effect</strong></summary>

**Authors**: Haodong Li, Alan Hubbard, Mark van der Laan\
**Link**: [arXiv:2309.13324v1](https://arxiv.org/abs/2309.13324v1)\
**Keywords**: tmle, targeted maximum likelihood, targeted learning
...
<summary><strong>2023-09-20 — Optimizing Dynamic Predictions from Joint Models using Super Learning</strong></summary>

**Authors**: Dimitris Rizopoulos, Jeremy M. G. Taylor\
**Link**: [arXiv:2309.11472v2](https://arxiv.org/abs/2309.11472v2)\
**Keywords**: super learning
...
<summary><strong>2023-09-07 — The Causal Roadmap and Simulations to Improve the Rigor and Reproducibility of Real-Data Applications</strong></summary>

**Authors**: Nerissa Nance, Maya L. Petersen, Mark van der Laan, Laura B. Balzer\
**Link**: [arXiv:2309.03952v5](https://arxiv.org/abs/2309.03952v5)\
**Keywords**: tmle, targeted minimum loss-based estimation
...
<summary><strong>2023-08-08 — SLEM: Machine Learning for Path Modeling and Causal Inference with Super Learner Equation Modeling</strong></summary>

**Authors**: Matthew J. Vowels\
**Link**: [arXiv:2308.04365v6](https://arxiv.org/abs/2308.04365v6)\
**Keywords**: super learner
...
<summary><strong>2023-07-11 — Considerations for Master Protocols Using External Controls</strong></summary>

**Authors**: Jie Chen, Xiaoyun, Li, Chengxing, Lu, Sammy Yuan, Godwin Yung, Jingjing Ye, Hong Tian, Jianchang Lin\
**Link**: [arXiv:2307.05050v2](https://arxiv.org/abs/2307.05050v2)\
**Keywords**: targeted learning
...
<summary><strong>2023-06-14 — Kernel Debiased Plug-in Estimation: Simultaneous, Automated Debiasing without Influence Functions for Many Target Parameters</strong></summary>

**Authors**: Brian Cho, Yaroslav Mukhin, Kyra Gan, Ivana Malenica\
**Link**: [arXiv:2306.08598v5](https://arxiv.org/abs/2306.08598v5)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2023-06-13 — ACE: Active Learning for Causal Inference with Expensive Experiments</strong></summary>

**Authors**: Difan Song, Simon Mak, C. F. Jeff Wu\
**Link**: [arXiv:2306.07480v1](https://arxiv.org/abs/2306.07480v1)\
**Keywords**: targeted learning
...
<summary><strong>2023-05-17 — Nonparametric estimation of the interventional disparity indirect effect among the exposed</strong></summary>

**Authors**: Helene C. W. Rytgaard, Amalie Lykkemark Møller, Thomas A. Gerds\
**Link**: [arXiv:2305.10095v1](https://arxiv.org/abs/2305.10095v1)\
**Keywords**: tmle, targeted minimum loss-based estimation
...
<summary><strong>2023-05-12 — A Causal Roadmap for Hybrid Randomized and Real-World Data Designs: Case Study of Semaglutide and Cardiovascular Outcomes</strong></summary>
...
**Link**: [arXiv:2305.07647v1](https://arxiv.org/abs/2305.07647v1)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2023-05-03 — Semiparametric Discovery and Estimation of Interaction in Mixed Exposures using Stochastic Interventions</strong></summary>

**Authors**: David B. McCoy, Alan E. Hubbard, Alejandro Schuler, Mark J. van der Laan\
**Link**: [arXiv:2305.01849v3](https://arxiv.org/abs/2305.01849v3)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2023-04-11 — A nonparametric framework for treatment effect modifier discovery in high dimensions</strong></summary>

**Authors**: Philippe Boileau, Ning Leng, Nima S. Hejazi, Mark van der Laan, Sandrine Dudoit\
**Link**: [arXiv:2304.05323v2](https://arxiv.org/abs/2304.05323v2)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2023-04-11 — Targeted Maximum Likelihood Based Estimation for Longitudinal Mediation Analysis</strong></summary>

**Authors**: Zeyi Wang, Lars van der Laan, Maya Petersen, Thomas Gerds, Kajsa Kvist, Mark van der Laan\
**Link**: [arXiv:2304.04904v1](https://arxiv.org/abs/2304.04904v1)\
**Keywords**: tmle, targeted maximum likelihood, highly adaptive lasso
...
<summary><strong>2023-03-20 — Semiparametric logistic regression for inference on relative vaccine efficacy in case-only studies with informative missingness</strong></summary>

**Authors**: Lars van der Laan, Peter B. Gilbert\
**Link**: [arXiv:2303.11462v2](https://arxiv.org/abs/2303.11462v2)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2023-03-13 — Application of targeted maximum likelihood estimation in public health and epidemiological studies: a systematic review</strong></summary>

**Authors**: Matthew J. Smith, Rachael V. Phillips, Miguel Angel Luque-Fernandez, Camille Maringe\
**Link**: [arXiv:2303.07329v1](https://arxiv.org/abs/2303.07329v1)\
**Keywords**: tmle, targeted maximum likelihood, targeted learning
...
<summary><strong>2023-02-15 — Discovery of Critical Thresholds in Mixed Exposures and Estimation of Policy Intervention Effects using Targeted Learning</strong></summary>

**Authors**: David McCoy, Alan Hubbard, Alejandro Schuler, Mark van der Laan\
**Link**: [arXiv:2302.07976v3](https://arxiv.org/abs/2302.07976v3)\
**Keywords**: targeted learning
...
<summary><strong>2023-02-03 — VR-LENS: Super Learning-based Cybersickness Detection and Explainable AI-Guided Deployment in Virtual Reality</strong></summary>

**Authors**: Ripan Kumar Kundu, Osama Yahia Elsaid, Prasad Calyam, Khaza Anuarul Hoque\
**Link**: [arXiv:2302.01985v1](https://arxiv.org/abs/2302.01985v1)\
**Keywords**: super learner, super learning
...
<summary><strong>2023-01-31 — Higher Order Spline Highly Adaptive Lasso Estimators of Functional Parameters: Pointwise Asymptotic Normality and Uniform Convergence Rates</strong></summary>

**Authors**: Mark van der Laan\
**Link**: [arXiv:2301.13354v1](https://arxiv.org/abs/2301.13354v1)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2023-01-27 — Multi-task Highly Adaptive Lasso</strong></summary>

**Authors**: Ivana Malenica, Rachael V. Phillips, Daniel Lazzareschi, Jeremy R. Coyle, Romain Pirracchio, Mark J. van der Laan\
**Link**: [arXiv:2301.12029v1](https://arxiv.org/abs/2301.12029v1)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2023-01-25 — Inference in Marginal Structural Models by Automatic Targeted Bayesian and Minimum Loss-Based Estimation</strong></summary>

**Authors**: Herbert Susmann, Antoine Chambaz\
**Link**: [arXiv:2301.10630v1](https://arxiv.org/abs/2301.10630v1)\
**Keywords**: targeted minimum loss-based estimation
...
<summary><strong>2022-12-30 — Data-driven photometric redshift estimation from type Ia supernovae light curves</strong></summary>

**Authors**: Felipe M F de Oliveira, Marcelo Vargas dos Santos, Ribamar R R Reis\
**Link**: [arXiv:2212.14668v2](https://arxiv.org/abs/2212.14668v2)\
**Keywords**: super learning
...
<summary><strong>2022-12-07 — Combining Planning, Reasoning and Reinforcement Learning to solve Industrial Robot Tasks</strong></summary>

**Authors**: Matthias Mayr, Faseeh Ahmad, Konstantinos Chatzilygeroudis, Luigi Nardi, Volker Krueger\
**Link**: [arXiv:2212.03570v1](https://arxiv.org/abs/2212.03570v1)\
**Keywords**: targeted learning
...
<summary><strong>2022-12-05 — Adaptive Sequential Surveillance with Network and Temporal Dependence</strong></summary>

**Authors**: Ivana Malenica, Jeremy R. Coyle, Mark J. van der Laan, Maya L. Petersen\
**Link**: [arXiv:2212.02422v1](https://arxiv.org/abs/2212.02422v1)\
**Keywords**: super learner
...
<summary><strong>2022-11-26 — Efficient Targeted Learning of Heterogeneous Treatment Effects for Multiple Subgroups</strong></summary>

**Authors**: Waverly Wei, Maya Petersen, Mark J van der Laan, Zeyu Zheng, Chong Wu, Jingshen Wang\
**Link**: [arXiv:2211.14671v1](https://arxiv.org/abs/2211.14671v1)\
**Keywords**: tmle, targeted learning
...
<summary><strong>2022-11-18 — All models are wrong, but which are useful? Comparing parametric and nonparametric estimation of causal effects in finite samples</strong></summary>

**Authors**: Kara E. Rudolph, Nicholas Williams, Caleb H. Miles, Joseph Antonelli, Ivan Diaz\
**Link**: [arXiv:2211.10310v2](https://arxiv.org/abs/2211.10310v2)\
**Keywords**: None listed
...
<summary><strong>2022-10-31 — Adaptive Selection of the Optimal Strategy to Improve Precision and Power in Randomized Trials</strong></summary>

**Authors**: Laura B. Balzer, Erica Cai, Lucas Godoy Garraza, Pracheta Amaranath\
**Link**: [arXiv:2210.17453v3](https://arxiv.org/abs/2210.17453v3)\
**Keywords**: tmle
...
<summary><strong>2022-10-11 — Experiment-selector cross-validated targeted maximum likelihood estimator for hybrid RCT-external data studies</strong></summary>
...
**Link**: [arXiv:2210.05802v4](https://arxiv.org/abs/2210.05802v4)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2022-10-07 — Efficient and Robust Approaches for Analysis of SMARTs: Illustration using the ADAPT-R Trial</strong></summary>

**Authors**: Lina M. Montoya, Michael R. Kosorok, Elvin H. Geng, Joshua Schwab, Thomas A. Odeny, Maya L. Petersen\
**Link**: [arXiv:2210.03316v1](https://arxiv.org/abs/2210.03316v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2022-09-20 — Neural Graph Databases</strong></summary>
...
**Link**: [arXiv:2209.09732v2](https://arxiv.org/abs/2209.09732v2)\
**Keywords**: targeted learning
...
<summary><strong>2022-09-15 — Frameworks for Estimating Causal Effects in Observational Settings: Comparing Confounder Adjustment and Instrumental Variables</strong></summary>

**Authors**: Roy S. Zawadzki, Joshua D. Grill, Daniel L. Gillen\
**Link**: [arXiv:2209.06984v3](https://arxiv.org/abs/2209.06984v3)\
**Keywords**: tmle
...
<summary><strong>2022-08-30 — Tree-based Subgroup Discovery In Electronic Health Records: Heterogeneity of Treatment Effects for DTG-containing Therapies</strong></summary>

**Authors**: Jiabei Yang, Ann W. Mwangi, Rami Kantor, Issa J. Dahabreh, Monicah Nyambura, Allison Delong, Joseph W. Hogan, Jon A. Steingrimsson\
**Link**: [arXiv:2208.14329v1](https://arxiv.org/abs/2208.14329v1)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2022-08-19 — Blurring cluster randomized trials and observational studies using Two-Stage TMLE to address sub-sampling, missingness, and minimal independent units</strong></summary>

**Authors**: Joshua R. Nugent, Carina Marquez, Edwin D. Charlebois, Rachel Abbott, Laura B. Balzer\
**Link**: [arXiv:2208.09508v2](https://arxiv.org/abs/2208.09508v2)\
**Keywords**: tmle, targeted minimum loss-based estimation
...
<summary><strong>2022-08-15 — Evaluating and improving real-world evidence with Targeted Learning</strong></summary>

**Authors**: Susan Gruber, Rachael V. Phillips, Hana Lee, John Concato, Mark van der Laan\
**Link**: [arXiv:2208.07283v1](https://arxiv.org/abs/2208.07283v1)\
**Keywords**: targeted learning
...
<summary><strong>2022-08-01 — Using Targeted Maximum Likelihood Estimation to Estimate Treatment Effect with Longitudinal Continuous or Binary Data: A Systematic Evaluation of 28 Diabetes Clinical Trials</strong></summary>

**Authors**: Lingjing Jiang, Michael Rosenblum, Yu Du\
**Link**: [arXiv:2208.01168v1](https://arxiv.org/abs/2208.01168v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2022-06-30 — Targeted learning in observational studies with multi-valued treatments: An evaluation of antipsychotic drug treatment safety</strong></summary>
...
**Link**: [arXiv:2206.15367v6](https://arxiv.org/abs/2206.15367v6)\
**Keywords**: tmle, targeted minimum loss-based estimation, targeted learning
...
<summary><strong>2022-06-23 — Forecasting the cost of drought events in France by Super Learning</strong></summary>

**Authors**: Geoffrey Ecoto, Antoine Chambaz\
**Link**: [arXiv:2206.11545v2](https://arxiv.org/abs/2206.11545v2)\
**Keywords**: super learner, super learning
...
<summary><strong>2022-06-12 — Identifying and estimating effects of sustained interventions under parallel trends assumptions</strong></summary>

**Authors**: Audrey Renson, Michael Hudgens, Alexander Keil, Paul Zivich, Allison Aiello\
**Link**: [arXiv:2206.05788v2](https://arxiv.org/abs/2206.05788v2)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2022-05-17 — Targeted learning: Towards a future informed by real-world evidence</strong></summary>

**Authors**: Susan Gruber, Rachael V. Phillips, Hana Lee, Martin Ho, John Concato, Mark J. van der Laan\
**Link**: [arXiv:2205.08643v2](https://arxiv.org/abs/2205.08643v2)\
**Keywords**: targeted minimum loss-based estimation, targeted learning, super learning
...
<summary><strong>2022-05-13 — A Huber loss-based super learner with applications to healthcare expenditures</strong></summary>

**Authors**: Ziyue Wu, David Benkeser\
**Link**: [arXiv:2205.06870v1](https://arxiv.org/abs/2205.06870v1)\
**Keywords**: super learner, super learning
...
<summary><strong>2022-04-23 — Double Machine Learning Methods for Estimating Average Treatment Effects: A Comparative Study</strong></summary>

**Authors**: Xiaoqing Tan, Shu Yang, Wenyu Ye, Douglas E. Faries, Ilya Lipkovich, Zbigniew Kadziola\
**Link**: [arXiv:2204.10969v5](https://arxiv.org/abs/2204.10969v5)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2022-04-13 — Practical considerations for specifying a super learner</strong></summary>

**Authors**: Rachael V. Phillips, Mark J. van der Laan, Hana Lee, Susan Gruber\
**Link**: [arXiv:2204.06139v4](https://arxiv.org/abs/2204.06139v4)\
**Keywords**: super learner
...
<summary><strong>2022-03-23 — Explaining Practical Differences Between Treatment Effect Estimators with High Dimensional Asymptotics</strong></summary>

**Authors**: Steve Yadlowsky\
**Link**: [arXiv:2203.12538v2](https://arxiv.org/abs/2203.12538v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2022-03-19 — CausalDeepCENT: Deep Learning for Causal Prediction of Individual Event Times</strong></summary>

**Authors**: Jong-Hyeon Jeong, Yichen Jia\
**Link**: [arXiv:2203.10207v1](https://arxiv.org/abs/2203.10207v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2022-03-09 — SuperCone: Unified User Segmentation over Heterogeneous Experts via Concept Meta-learning</strong></summary>

**Authors**: Keqian Li, Yifan Hu\
**Link**: [arXiv:2203.07029v2](https://arxiv.org/abs/2203.07029v2)\
**Keywords**: super learning
...
<summary><strong>2021-12-15 — A Targeted Approach to Confounder Selection for High-Dimensional Data</strong></summary>

**Authors**: Asad Haris, Robert Platt\
**Link**: [arXiv:2112.08495v1](https://arxiv.org/abs/2112.08495v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2021-12-10 — Handling missing data when estimating causal effects with Targeted Maximum Likelihood Estimation</strong></summary>

**Authors**: S. Ghazaleh Dashti, Katherine J. Lee, Julie A. Simpson, Ian R. White, John B. Carlin, Margarita Moreno-Betancur\
**Link**: [arXiv:2112.05274v4](https://arxiv.org/abs/2112.05274v4)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2021-10-24 — Evaluating shifts in mobility and COVID-19 case rates in U.S. counties: A demonstration of modified treatment policies for causal inference with continuous exposures</strong></summary>

**Authors**: Joshua R. Nugent, Laura B. Balzer\
**Link**: [arXiv:2110.12529v3](https://arxiv.org/abs/2110.12529v3)\
**Keywords**: tmle, targeted minimum loss-based estimation, super learner
...
<summary><strong>2021-10-19 — CIMTx: An R package for causal inference with multiple treatments using observational data</strong></summary>

**Authors**: Liangyuan Hu, Jiayi Ji\
**Link**: [arXiv:2110.10276v3](https://arxiv.org/abs/2110.10276v3)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2021-10-18 — Defining and Estimating Effects in Cluster Randomized Trials: A Methods Comparison</strong></summary>
...
**Link**: [arXiv:2110.09633v4](https://arxiv.org/abs/2110.09633v4)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2021-10-12 — Evaluating the Impact of State-Level Public Masking Mandates on New COVID-19 Cases and Deaths in the United States: A Demonstration of the Causal Roadmap</strong></summary>

**Authors**: Angus K. Wong, Laura B. Balzer\
**Link**: [arXiv:2110.06115v1](https://arxiv.org/abs/2110.06115v1)\
**Keywords**: tmle, targeted maximum likelihood, super learner
...
<summary><strong>2021-09-28 — Evaluating the Robustness of Targeted Maximum Likelihood Estimators via Realistic Simulations in Nutrition Intervention Trials</strong></summary>

**Authors**: Haodong Li, Sonali Rosete, Jeremy Coyle, Rachael V. Phillips, Nima S. Hejazi, Ivana Malenica, Benjamin F. Arnold, Jade Benjamin-Chung, Andrew Mertens, John M. Colford, Mark J. van der Laan, Alan E. Hubbard\
**Link**: [arXiv:2109.14048v1](https://arxiv.org/abs/2109.14048v1)\
**Keywords**: targeted maximum likelihood, highly adaptive lasso
...
<summary><strong>2021-09-21 — Personalized Online Machine Learning</strong></summary>

**Authors**: Ivana Malenica, Rachael V. Phillips, Romain Pirracchio, Antoine Chambaz, Alan Hubbard, Mark J. van der Laan\
**Link**: [arXiv:2109.10452v1](https://arxiv.org/abs/2109.10452v1)\
**Keywords**: super learner
...
<summary><strong>2021-07-28 — One-step ahead sequential Super Learning from short times series of many slightly dependent data, and anticipating the cost of natural disasters</strong></summary>

**Authors**: Geoffrey Ecoto, Aurélien Bibaut, Antoine Chambaz\
**Link**: [arXiv:2107.13291v1](https://arxiv.org/abs/2107.13291v1)\
**Keywords**: super learner, super learning
...
<summary><strong>2021-07-23 — Efficient nonparametric estimation of the covariate-adjusted threshold-response function, a support-restricted stochastic intervention</strong></summary>

**Authors**: Lars van der Laan, Wenbo Zhang, Peter B. Gilbert\
**Link**: [arXiv:2107.11459v2](https://arxiv.org/abs/2107.11459v2)\
**Keywords**: tmle
...
<summary><strong>2021-07-04 — One-step TMLE for targeting cause-specific absolute risks and survival curves</strong></summary>

**Authors**: Helene C. W. Rytgaard, Mark J. van der Laan\
**Link**: [arXiv:2107.01537v2](https://arxiv.org/abs/2107.01537v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2021-06-29 — Two-Stage TMLE to Reduce Bias and Improve Efficiency in Cluster Randomized Trials</strong></summary>
...
**Link**: [arXiv:2106.15737v2](https://arxiv.org/abs/2106.15737v2)\
**Keywords**: tmle
...
<summary><strong>2021-06-21 — Estimation of time-specific intervention effects on continuously distributed time-to-event outcomes by targeted maximum likelihood estimation</strong></summary>

**Authors**: Helene Charlotte Wiese Rytgaard, Frank Eriksson, Mark van der Laan\
**Link**: [arXiv:2106.11009v1](https://arxiv.org/abs/2106.11009v1)\
**Keywords**: targeted maximum likelihood, highly adaptive lasso
...
<summary><strong>2021-05-05 — Continuous-time targeted minimum loss-based estimation of intervention-specific mean outcomes</strong></summary>

**Authors**: Helene C. Rytgaard, Thomas A. Gerds, Mark J. van der Laan\
**Link**: [arXiv:2105.02088v1](https://arxiv.org/abs/2105.02088v1)\
**Keywords**: tmle, targeted minimum loss-based estimation, highly adaptive lasso
...
<summary><strong>2021-05-01 — Detecting bid-rigging coalitions in different countries and auction formats</strong></summary>

**Authors**: David Imhof, Hannes Wallimann\
**Link**: [arXiv:2105.00337v1](https://arxiv.org/abs/2105.00337v1)\
**Keywords**: super learner
...
<summary><strong>2021-01-29 — Performance and Application of Estimators for the Value of an Optimal Dynamic Treatment Rule</strong></summary>

**Authors**: Lina Montoya, Jennifer Skeem, Mark van der Laan, Maya Petersen\
**Link**: [arXiv:2101.12333v4](https://arxiv.org/abs/2101.12333v4)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2021-01-15 — Higher Order Targeted Maximum Likelihood Estimation</strong></summary>

**Authors**: Mark van der Laan, Zeyi Wang, Lars van der Laan\
**Link**: [arXiv:2101.06290v3](https://arxiv.org/abs/2101.06290v3)\
**Keywords**: tmle, targeted maximum likelihood, highly adaptive lasso
...
<summary><strong>2021-01-11 — Modeling Treatment Effect Modification in Multidrug-Resistant Tuberculosis in an Individual Patient Data Meta-Analysis</strong></summary>

**Authors**: Yan Liu, Mireille Schnitzer, Guanbo Wang, Edward Kennedy, Piret Viiklepp, Mario H. Vargas, Giovanni Sotgiu, Dick Menzies, Andrea Benedetti\
**Link**: [arXiv:2101.03997v2](https://arxiv.org/abs/2101.03997v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2020-07-02 — Multi-resolution Super Learner for Voxel-wise Classification of Prostate Cancer Using Multi-parametric MRI</strong></summary>

**Authors**: Jin Jin, Lin Zhang, Ethan Leng, Gregory J. Metzger, Joseph S. Koopmeiners\
**Link**: [arXiv:2007.00816v2](https://arxiv.org/abs/2007.00816v2)\
**Keywords**: super learner
...
<summary><strong>2020-06-16 — Model Agnostic Combination for Ensemble Learning</strong></summary>

**Authors**: Ohad Silbert, Yitzhak Peleg, Evi Kopelowitz\
**Link**: [arXiv:2006.09025v1](https://arxiv.org/abs/2006.09025v1)\
**Keywords**: super learner
...
<summary><strong>2020-06-15 — Targeted Maximum Likelihood Estimation of Community-based Causal Effect of Community-Level Stochastic Interventions</strong></summary>

**Authors**: Chi Zhang, Jennifer Ahern, Mark J. van der Laan\
**Link**: [arXiv:2006.08675v1](https://arxiv.org/abs/2006.08675v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2020-06-15 — tmleCommunity: A R Package Implementing Target Maximum Likelihood Estimation for Community-level Data</strong></summary>

**Authors**: Chi Zhang, Jennifer Ahern, Mark J. van der Laan, Oleg Sofrygin\
**Link**: [arXiv:2006.08553v1](https://arxiv.org/abs/2006.08553v1)\
**Keywords**: tmle, targeted minimum loss-based estimation
...
<summary><strong>2020-05-22 — Nonparametric inverse probability weighted estimators based on the highly adaptive lasso</strong></summary>

**Authors**: Ashkan Ertefaie, Nima S. Hejazi, Mark J. van der Laan\
**Link**: [arXiv:2005.11303v2](https://arxiv.org/abs/2005.11303v2)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2020-04-21 — Machine learning for causal inference: on the use of cross-fit estimators</strong></summary>

**Authors**: Paul N Zivich, Alexander Breskin\
**Link**: [arXiv:2004.10337v4](https://arxiv.org/abs/2004.10337v4)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2020-04-03 — Stacked Generalizations in Imbalanced Fraud Data Sets using Resampling Methods</strong></summary>

**Authors**: Kathleen Kerwin, Nathaniel D. Bastian\
**Link**: [arXiv:2004.01764v1](https://arxiv.org/abs/2004.01764v1)\
**Keywords**: super learner
...
<summary><strong>2020-03-18 — Bootstrap Bias Corrected Cross Validation applied to Super Learning</strong></summary>

**Authors**: Krzysztof Mnich, Agnieszka Kitlas Golińska, Aneta Polewko-Klim, Witold R. Rudnicki\
**Link**: [arXiv:2003.08342v1](https://arxiv.org/abs/2003.08342v1)\
**Keywords**: super learner, super learning
...
<summary><strong>2020-03-04 — Estimating the Effect of Central Bank Independence on Inflation Using Longitudinal Targeted Maximum Likelihood Estimation</strong></summary>

**Authors**: Philipp F. M. Baumann, Michael Schomaker, Enzo Rossi\
**Link**: [arXiv:2003.02208v7](https://arxiv.org/abs/2003.02208v7)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2020-01-17 — Estimation of Causal Effects of Multiple Treatments in Observational Studies with a Binary Outcome</strong></summary>

**Authors**: Liangyuan Hu, Chenyang Gu, Michael Lopez, Jiayi Ji, Juan Wisnivesky\
**Link**: [arXiv:2001.06483v1](https://arxiv.org/abs/2001.06483v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2019-12-13 — Conditional Super Learner</strong></summary>

**Authors**: Gilmer Valdes, Yannet Interian, Efstathios D. Gennatas Mark J. Van der Laan\
**Link**: [arXiv:1912.06675v1](https://arxiv.org/abs/1912.06675v1)\
**Keywords**: super learner
...
<summary><strong>2019-12-13 — More Efficient Off-Policy Evaluation through Regularized Targeted Learning</strong></summary>

**Authors**: Aurélien F. Bibaut, Ivana Malenica, Nikos Vlassis, Mark J. van der Laan\
**Link**: [arXiv:1912.06292v1](https://arxiv.org/abs/1912.06292v1)\
**Keywords**: targeted maximum likelihood, targeted learning
...
<summary><strong>2019-12-03 — Confounding Adjustment Methods for Multi-level Treatment Comparisons Under Lack of Positivity and Unknown Model Specification</strong></summary>

**Authors**: Diop S. Arona, Duchesne Thierry, Cumming Steven, Diop Awa, Talbot Denis\
**Link**: [arXiv:1912.01517v2](https://arxiv.org/abs/1912.01517v2)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2019-10-26 — SUPER Learning: A Supervised-Unsupervised Framework for Low-Dose CT Image Reconstruction</strong></summary>

**Authors**: Zhipeng Li, Siqi Ye, Yong Long, Saiprasad Ravishankar\
**Link**: [arXiv:1910.12024v1](https://arxiv.org/abs/1910.12024v1)\
**Keywords**: super learning
...
<summary><strong>2019-10-20 — Targeted Estimation of Heterogeneous Treatment Effect in Observational Survival Analysis</strong></summary>

**Authors**: Jie Zhu, Blanca Gallego\
**Link**: [arXiv:1910.08877v2](https://arxiv.org/abs/1910.08877v2)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2019-10-13 — Improving Precision through Adjustment for Prognostic Variables in Group Sequential Trial Designs: Impact of Baseline Variables, Short-Term Outcomes, and Treatment Effect Heterogeneity</strong></summary>

**Authors**: Tianchen Qian, Michael Rosenblum, Huitong Qiu\
**Link**: [arXiv:1910.05800v2](https://arxiv.org/abs/1910.05800v2)\
**Keywords**: None listed
...
<summary><strong>2019-09-27 — A Data-Adaptive Targeted Learning Approach of Evaluating Viscoelastic Assay Driven Trauma Treatment Protocols</strong></summary>

**Authors**: Linqing Wei, Lucy Z. Kornblith, Alan Hubbard\
**Link**: [arXiv:1909.12881v2](https://arxiv.org/abs/1909.12881v2)\
**Keywords**: tmle, targeted learning, super learning
...
<summary><strong>2019-09-09 — Super ensemble learning for daily streamflow forecasting: Large-scale demonstration and comparison with multiple machine learning algorithms</strong></summary>

**Authors**: Hristos Tyralis, Georgia Papacharalampous, Andreas Langousis\
**Link**: [arXiv:1909.04131v2](https://arxiv.org/abs/1909.04131v2)\
**Keywords**: super learner, super learning
...
<summary><strong>2019-08-16 — Efficient Estimation of Pathwise Differentiable Target Parameters with the Undersmoothed Highly Adaptive Lasso</strong></summary>

**Authors**: Mark J. van der Laan, David Benkeser, Weixin Cai\
**Link**: [arXiv:1908.05607](https://arxiv.org/abs/1908.05607)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2019-08-14 — Efficient Estimation of Pathwise Differentiable Target Parameters with the Undersmoothed Highly Adaptive Lasso</strong></summary>

**Authors**: Mark J. van der Laan, David Benkeser, Weixin Cai\
**Link**: [arXiv:1908.05607v2](https://arxiv.org/abs/1908.05607v2)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2019-07-10 — A Highly Efficient Distributed Deep Learning System For Automatic Speech Recognition</strong></summary>
...
**Link**: [arXiv:1907.05701v1](https://arxiv.org/abs/1907.05701v1)\
**Keywords**: super learner
...
<summary><strong>2019-06-21 — Design and analysis considerations for a sequentially randomized HIV prevention trial</strong></summary>

**Authors**: David Benkeser, Keith Horvath, Cathy Reback, Joshua Rusow, Michael Hudgens\
**Link**: [arXiv:1906.09304v1](https://arxiv.org/abs/1906.09304v1)\
**Keywords**: None listed
...
<summary><strong>2019-05-31 — Targeted Estimation of L2 Distance Between Densities and its Application to Geo-spatial Data</strong></summary>

**Authors**: George Shan, Mark J. van der Laan\
**Link**: [arXiv:1905.13414v1](https://arxiv.org/abs/1905.13414v1)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2019-05-23 — Nonparametric Bootstrap Inference for the Targeted Highly Adaptive LASSO Estimator</strong></summary>

**Authors**: Weixin Cai, Mark van der Laan\
**Link**: [arXiv:1905.10299v2](https://arxiv.org/abs/1905.10299v2)\
**Keywords**: tmle, highly adaptive lasso
...
<summary><strong>2019-03-05 — Tutorial: Deriving The Efficient Influence Curve for Large Models</strong></summary>

**Authors**: Jonathan Levy\
**Link**: [arXiv:1903.01706v3](https://arxiv.org/abs/1903.01706v3)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2019-03-01 — Machine learning in policy evaluation: new tools for causal inference</strong></summary>

**Authors**: Noemi Kreif, Karla DiazOrdaz\
**Link**: [arXiv:1903.00402v1](https://arxiv.org/abs/1903.00402v1)\
**Keywords**: targeted maximum likelihood, super learner
...
<summary><strong>2018-11-15 — Kernel Smoothing of the Treatment Effect CDF</strong></summary>

**Authors**: Jonathan Levy, Mark van der Laan\
**Link**: [arXiv:1811.06514v4](https://arxiv.org/abs/1811.06514v4)\
**Keywords**: tmle
...
<summary><strong>2018-11-12 — An Easy Implementation of CV-TMLE</strong></summary>

**Authors**: Jonathan Levy\
**Link**: [arXiv:1811.04573v2](https://arxiv.org/abs/1811.04573v2)\
**Keywords**: tmle, targeted maximum likelihood, targeted learning
...
<summary><strong>2018-11-09 — A Fundamental Measure of Treatment Effect Heterogeneity</strong></summary>

**Authors**: Jonathan Levy, Mark van der Laan, Alan Hubbard, Romain Pirracchio\
**Link**: [arXiv:1811.03745v3](https://arxiv.org/abs/1811.03745v3)\
**Keywords**: tmle
...
<summary><strong>2018-11-03 — Canonical Least Favorable Submodels:A New TMLE Procedure for Multidimensional Parameters</strong></summary>

**Authors**: Jonathan Levy\
**Link**: [arXiv:1811.01261v3](https://arxiv.org/abs/1811.01261v3)\
**Keywords**: tmle, targeted maximum likelihood, targeted learning
...
<summary><strong>2018-10-29 — Complier stochastic direct effects: identification and robust estimation</strong></summary>

**Authors**: Kara E Rudolph, Oleg Sofrygin, Mark J van der Laan\
**Link**: [arXiv:1810.12452v1](https://arxiv.org/abs/1810.12452v1)\
**Keywords**: tmle
...
<summary><strong>2018-09-07 — A Primer on Causality in Data Science</strong></summary>

**Authors**: Hachem Saddiki, Laura B. Balzer\
**Link**: [arXiv:1809.02408v2](https://arxiv.org/abs/1809.02408v2)\
**Keywords**: tmle, targeted maximum likelihood, super learner
...
<summary><strong>2018-09-03 — Robust Estimation of Data-Dependent Causal Effects based on Observing a Single Time-Series</strong></summary>

**Authors**: Mark J. van der Laan, Ivana Malenica\
**Link**: [arXiv:1809.00734v1](https://arxiv.org/abs/1809.00734v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2018-06-18 — Robust inference on the average treatment effect using the outcome highly adaptive lasso</strong></summary>

**Authors**: Cheng Ju, David Benkeser, Mark J. van der Laan\
**Link**: [arXiv:1806.06784v3](https://arxiv.org/abs/1806.06784v3)\
**Keywords**: highly adaptive lasso
...
<summary><strong>2018-05-21 — Super learning in the SAS system</strong></summary>

**Authors**: Alexander P. Keil, Daniel Westreich, Jessie K Edwards, Stephen R Cole\
**Link**: [arXiv:1805.08058v3](https://arxiv.org/abs/1805.08058v3)\
**Keywords**: super learner, super learning
...
<summary><strong>2018-04-01 — Flexible model selection for mechanistic network models</strong></summary>

**Authors**: Sixing Chen, Antonietta Mira, Jukka-Pekka Onnela\
**Link**: [arXiv:1804.00237v2](https://arxiv.org/abs/1804.00237v2)\
**Keywords**: super learner
...
<summary><strong>2018-03-31 — Collaborative targeted inference from continuously indexed nuisance parameter estimators</strong></summary>

**Authors**: Cheng Ju, Antoine Chambaz, Mark J. van der Laan\
**Link**: [arXiv:1804.00102v2](https://arxiv.org/abs/1804.00102v2)\
**Keywords**: tmle
...
<summary><strong>2018-03-06 — Deep Super Learner: A Deep Ensemble for Classification Problems</strong></summary>

**Authors**: Steven Young, Tamer Abdou, Ayse Bener\
**Link**: [arXiv:1803.02323v1](https://arxiv.org/abs/1803.02323v1)\
**Keywords**: super learner, super learning
...
<summary><strong>2018-02-26 — One-step Targeted Maximum Likelihood for Time-to-event Outcomes</strong></summary>

**Authors**: Weixin Cai, Mark J. van der Laan\
**Link**: [arXiv:1802.09479v3](https://arxiv.org/abs/1802.09479v3)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2018-02-14 — Using Longitudinal Targeted Maximum Likelihood Estimation in Complex Settings with Dynamic Interventions</strong></summary>

**Authors**: Michael Schomaker, Miguel Angel Luque-Fernandez, Valeriane Leroy, Mary-Ann Davies\
**Link**: [arXiv:1802.05005v9](https://arxiv.org/abs/1802.05005v9)\
**Keywords**: tmle, targeted maximum likelihood, targeted maximum likelihood estimation
...
<summary><strong>2018-02-08 — Data-adaptive doubly robust instrumental variable methods for treatment effect heterogeneity</strong></summary>

**Authors**: Karla DiazOrdaz, Rhian Daniel, Noemi Kreif\
**Link**: [arXiv:1802.02821v2](https://arxiv.org/abs/1802.02821v2)\
**Keywords**: tmle, super learner
...
<summary><strong>2017-12-15 — Efficient Principally Stratified Treatment Effect Estimation in Crossover Studies with Absorbent Binary Endpoints</strong></summary>

**Authors**: Alex Luedtke, Jiacheng Wu\
**Link**: [arXiv:1712.05835v2](https://arxiv.org/abs/1712.05835v2)\
**Keywords**: None listed
...
<summary><strong>2017-10-26 — Causal Inference When Counterfactuals Depend on the Proportion of All Subjects Exposed</strong></summary>

**Authors**: Caleb H. Miles, Maya Petersen, Mark J. van der Laan\
**Link**: [arXiv:1710.09588v2](https://arxiv.org/abs/1710.09588v2)\
**Keywords**: targeted maximum likelihood
...
<summary><strong>2017-10-23 — Benchmark of Deep Learning Models on Large Healthcare MIMIC Datasets</strong></summary>

**Authors**: Sanjay Purushotham, Chuizheng Meng, Zhengping Che, Yan Liu\
**Link**: [arXiv:1710.08531v1](https://arxiv.org/abs/1710.08531v1)\
**Keywords**: super learner
...
<summary><strong>2017-09-19 — Uniform Consistency of the Highly Adaptive Lasso Estimator of Infinite Dimensional Parameters</strong></summary>

**Authors**: Mark J. van der Laan, Aurélien F. Bibaut\
**Link**: [arXiv:1709.06256v1](https://arxiv.org/abs/1709.06256v1)\
**Keywords**: tmle, highly adaptive lasso
...
<summary><strong>2017-08-30 — Finite Sample Inference for Targeted Learning</strong></summary>

**Authors**: Mark van der Laan\
**Link**: [arXiv:1708.09502v1](https://arxiv.org/abs/1708.09502v1)\
**Keywords**: tmle, targeted learning
...
<summary><strong>2017-07-27 — Robust and Flexible Estimation of Stochastic Mediation Effects: A Proposed Method and Example in a Randomized Trial Setting</strong></summary>

**Authors**: Kara E. Rudolph, Oleg Sofrygin, Wenjing Zheng, Mark J. van der Laan\
**Link**: [arXiv:1707.09021v2](https://arxiv.org/abs/1707.09021v2)\
**Keywords**: None listed
...
<summary><strong>2017-07-18 — On Adaptive Propensity Score Truncation in Causal Inference</strong></summary>

**Authors**: Cheng Ju, Joshua Schwab, Mark J. van der Laan\
**Link**: [arXiv:1707.05861v1](https://arxiv.org/abs/1707.05861v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2017-06-30 — Collaborative-controlled LASSO for Constructing Propensity Score-based Estimators in High-Dimensional Data</strong></summary>

**Authors**: Cheng Ju, Richard Wyss, Jessica M. Franklin, Sebastian Schneeweiss, Jenny Häggström, Mark J. van der Laan\
**Link**: [arXiv:1706.10029v1](https://arxiv.org/abs/1706.10029v1)\
**Keywords**: tmle
...
<summary><strong>2017-06-08 — A new approach to hierarchical data analysis: Targeted maximum likelihood estimation for the causal effect of a cluster-level exposure</strong></summary>

**Authors**: Laura B. Balzer, Wenjing Zheng, Mark J. van der Laan, Maya L. Petersen\
**Link**: [arXiv:1706.02675v2](https://arxiv.org/abs/1706.02675v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2017-05-27 — Targeted Learning with Daily EHR Data</strong></summary>

**Authors**: Oleg Sofrygin, Zheng Zhu, Julie A Schmittdiel, Alyce S. Adams, Richard W. Grant, Mark J. van der Laan, Romain Neugebauer\
**Link**: [arXiv:1705.09874v2](https://arxiv.org/abs/1705.09874v2)\
**Keywords**: tmle, targeted learning
...
<summary><strong>2017-05-06 — Sequential Double Robustness in Right-Censored Longitudinal Models</strong></summary>

**Authors**: Alexander R. Luedtke, Oleg Sofrygin, Mark J. van der Laan, Marco Carone\
**Link**: [arXiv:1705.02459v2](https://arxiv.org/abs/1705.02459v2)\
**Keywords**: targeted minimum loss-based estimation
...
<summary><strong>2017-04-05 — The Relative Performance of Ensemble Methods with Deep Convolutional Neural Networks for Image Classification</strong></summary>

**Authors**: Cheng Ju, Aurélien Bibaut, Mark J. van der Laan\
**Link**: [arXiv:1704.01664v1](https://arxiv.org/abs/1704.01664v1)\
**Keywords**: super learner
...
<summary><strong>2017-04-05 — Doubly Robust Inference for Targeted Minimum Loss Based Estimation in Randomized Trials with Missing Outcome Data</strong></summary>

**Authors**: Iván Díaz, Mark J. van der Laan\
**Link**: [arXiv:1704.01538v1](https://arxiv.org/abs/1704.01538v1)\
**Keywords**: targeted minimum loss based estimation
...
<summary><strong>2017-03-07 — Scalable Collaborative Targeted Learning for High-Dimensional Data</strong></summary>
...
**Link**: [arXiv:1703.02237v1](https://arxiv.org/abs/1703.02237v1)\
**Keywords**: tmle, targeted minimum loss-based estimation, targeted learning
...
<summary><strong>2017-03-07 — Propensity score prediction for electronic healthcare databases using Super Learner and High-dimensional Propensity Score Methods</strong></summary>

**Authors**: Cheng Ju, Mary Combs, Samuel D Lendle, Jessica M Franklin, Richard Wyss, Sebastian Schneeweiss, Mark J. van der Laan\
**Link**: [arXiv:1703.02236v2](https://arxiv.org/abs/1703.02236v2)\
**Keywords**: super learner
...
<summary><strong>2017-02-15 — Targeted Learning Ensembles for Optimal Individualized Treatment Rules with Time-to-Event Outcomes</strong></summary>

**Authors**: Iván Díaz, Oleksandr Savenkov, Karla Ballman\
**Link**: [arXiv:1702.04682v2](https://arxiv.org/abs/1702.04682v2)\
**Keywords**: targeted learning, super learning
...
<summary><strong>2016-06-30 — Practical targeted learning from large data sets by survey sampling</strong></summary>

**Authors**: Patrice Bertail, Antoine Chambaz, Emilien Joly\
**Link**: [arXiv:1606.09522v1](https://arxiv.org/abs/1606.09522v1)\
**Keywords**: tmle, targeted learning
...
<summary><strong>2015-12-26 — Efficient Estimation of Quantiles in Missing Data Models</strong></summary>

**Authors**: Iván Díaz\
**Link**: [arXiv:1512.08110v2](https://arxiv.org/abs/1512.08110v2)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2015-11-26 — Second-Order Inference for the Mean of a Variable Missing at Random</strong></summary>

**Authors**: Iván Díaz, Marco Carone, Mark J. van der Laan\
**Link**: [arXiv:1511.08369v1](https://arxiv.org/abs/1511.08369v1)\
**Keywords**: tmle, targeted minimum loss-based estimation
...
<summary><strong>2014-07-31 — Effect of breastfeeding on gastrointestinal infection in infants: A targeted maximum likelihood approach for clustered longitudinal data</strong></summary>

**Authors**: Mireille E. Schnitzer, Mark J. van der Laan, Erica E. M. Moodie, Robert W. Platt\
**Link**: [arXiv:1407.8371v1](https://arxiv.org/abs/1407.8371v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2014-06-02 — Targeted Maximum Likelihood Estimation using Exponential Families</strong></summary>

**Authors**: Iván Díaz, Michael Rosenblum\
**Link**: [arXiv:1406.0423v1](https://arxiv.org/abs/1406.0423v1)\
**Keywords**: tmle, targeted maximum likelihood
...
<summary><strong>2012-09-27 — Classification in postural style</strong></summary>

**Authors**: Antoine Chambaz, Christophe Denis\
**Link**: [arXiv:1209.6221v1](https://arxiv.org/abs/1209.6221v1)\
**Keywords**: targeted maximum likelihood
